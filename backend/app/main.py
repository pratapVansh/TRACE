...
from app.api.routes import admin_users, audit_logs, auth, chat, chunks, dashboard, demo, documents, graph, health, llm, metrics, observability, processing, rag, search, vector
...
def create_app() -> FastAPI:
    ...
    # Demo-only route; off unless DEMO_ROUTES_ENABLED is set.
